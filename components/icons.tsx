...
export const RocketIcon = ({ className }: { className?: string }) => (
    <svg
        ...
        strokeLinejoin="round"
    >
        <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.33-.04-3.8-.74-1.47-2.29-2.24-3.8-2.66-.43-.12-.86-.2-1.16-.22" />
        <path d="M17.5 7.5c1.5-1.26 2-5 2-5s-3.74.5-5 2c-.71.84-.7 2.33.04 3.8.74 1.47 2.29 2.24 3.8 2.66.43.12.86.2 1.16.22" />
        <path d="M16 8.5l3.5 3.5" />
        <path d="M2 14l6.5 6.5" />
    </svg>
);
...
export const WandSparklesIcon = ({ className }: { className?: string }) => (
    ...
    >
        ...
        <path d="m5 19 2-2" />
        <path d="m19 19-4-4" />
        <path d="m12.3 3.7.9-1.8.9 1.8" />
        <path d="M3.7 12.3l-1.8.9 1.8.9" />
        <path d="m20.3 12.3 1.8-.9-1.8-.9" />
        <path d="m12.3 20.3-.9 1.8-.9-1.8" />
